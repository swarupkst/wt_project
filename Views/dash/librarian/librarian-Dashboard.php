...
include '../../../Models/manage-Books.php';
// session_start();
...
<head>
    ...
    <link rel="stylesheet" href="../../../assets/styles/dash/librarian-Dashboard-Style.css" />
...
<body>
    <div class="container">
        ...
        <div class="nav-tabs">
            ...
            <button class="nav-tab active" onclick="showSection('books')">📚 Manage Books</button>
...
<div id="settings" class="content-section">
    ...
    <script src="../../../assets/scripts/dash/librarian-Dashboard-Script.js"></script>
